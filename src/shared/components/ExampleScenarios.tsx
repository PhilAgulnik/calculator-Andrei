...
const examples: ExampleScenario[] = [
  ...
  {
    id: 'fsm-england-eligible-sept-2026',
    name: 'England: Eligible from September 2026 (income £7,400–£20,000)',
    description: 'England with secondary child and income above the current £7,400 threshold but below the September 2026 threshold of £20,000 — eligible from September 2026',
    category: 'fsm-test',
    data: {
      area: 'england',
      postcode: 'OL3 6AA',
      ...
      partnerAge: 40,
      children: 1,
      childrenInfo: [{ age: 14, hasDisability: 'no' }],
      housingStatus: 'renting',
      tenantType: 'social',
      rent: 900,
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 1000, // £12,000/year net — above £7,400 current threshold, below £20,000 future threshold
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
  {
    id: 'fsm-scotland-no-uc',
    name: 'Scotland: Not Eligible (no UC — high earnings)',
    description: 'Scotland with P6+ secondary child but high combined earnings (£4,000 + £3,000/month) that wipe out UC entitlement entirely — not eligible for FSM',
    category: 'fsm-test',
    data: {
      area: 'scotland',
      postcode: 'EH1 1AA',
  ...
  {
    id: 'fsm-scotland-above-threshold-uc',
    name: 'Scotland: Above Threshold but Receives UC',
    description: 'Scotland, P6+ secondary child, earnings above £850/month but UC > 0 — not eligible in Scotland, but would be eligible if in England from September 2026',
    category: 'fsm-test',
    data: {
      area: 'scotland',
      postcode: 'G1 1AA',
      ...
      partnerAge: 37,
      children: 1,
      childrenInfo: [{ age: 13, hasDisability: 'no' }], // S2 - secondary
      housingStatus: 'renting',
      tenantType: 'social',
      rent: 800,
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 1000, // £12,000/year net — above Scotland £10,200 threshold
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
  {
    id: 'fsm-wales-above-threshold-uc',
    name: 'Wales: Above Threshold but Receives UC',
    description: 'Wales, secondary child, earnings above £7,400/year but UC > 0 — not eligible in Wales, but would be eligible from September 2026 if in England',
    category: 'fsm-test',
    data: {
      area: 'wales',
      postcode: 'CF24 1AA',
      ...
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 1000, // £12,000/year — above £7,400 Wales threshold
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
  {
    id: 'fsm-ni-above-threshold-uc',
    name: 'N. Ireland: Above Threshold but Receives UC',
    description: 'Northern Ireland, secondary child, earnings above £14,000/year but UC > 0 — not eligible in N. Ireland, but would be eligible from September 2026 if in England',
    category: 'fsm-test',
    data: {
      area: 'northern_ireland',
      postcode: 'BT2 1AA',
      ...
      partnerAge: 36,
      children: 1,
      childrenInfo: [{ age: 11, hasDisability: 'no' }], // Year 8 - secondary
      housingStatus: 'renting',
      tenantType: 'social',
      rent: 700,
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 1500, // £18,000/year — above £14,000 NI threshold
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
  {
    id: 'fsm-london-eligible',
    name: 'London: FSM Currently Eligible',
    description: 'Inner London (E1), single parent, part-time earnings below £7,400/year threshold — currently eligible',
    category: 'fsm-test',
    data: {
      area: 'england',
      postcode: 'E1 6RF',
  ...
  {
    id: 'fsm-london-eligible-sept-2026',
    name: 'London: Eligible from September 2026',
    description: 'South East London (SE15), couple, one earner above current threshold but below £20,000 — eligible from September 2026. Demonstrates London callout in the note.',
    category: 'fsm-test',
    data: {
      area: 'england',
      postcode: 'SE15 4AA',
      ...
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 1100, // £13,200/year net — above £7,400, below £20,000
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
  {
    id: 'fsm-london-not-eligible',
    name: 'London: Not Eligible (income over £20,000)',
    description: 'North London (N1), couple with secondary child, combined net income above £20,000/year — not eligible even from September 2026',
    category: 'fsm-test',
    data: {
      area: 'england',
      postcode: 'N1 9GU',
      ...
      rentPeriod: 'per_month',
      employmentType: 'employed',
      monthlyEarnings: 2000, // £24,000/year net — above £20,000 future threshold
      monthlyEarningsPeriod: 'per_month',
      partnerEmploymentType: 'not_working',
    },
  },
